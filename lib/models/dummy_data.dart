...
class DummyData {
  ...
  static final List<StudentModel> students = [
    StudentModel(
      ...
      courseType: AppConstants.courseTypes[1],
      batchId: 'batch_001',
    ...
    StudentModel(
      ...
      courseType: AppConstants.courseTypes[0],
      batchId: 'batch_002',
    ...
    StudentModel(
      ...
      courseType: AppConstants.courseTypes[2],
      batchId: 'batch_003',
    ...
    StudentModel(
      ...
      phone: '9876543216',
      role: AppConstants.roleStudent,
      branch: AppConstants.branches[3],
  ...
  static final List<StudyMaterialModel> materials = [
    StudyMaterialModel(
      ...
      targetCourses: [AppConstants.courseTypes[0], AppConstants.courseTypes[1]],
      fileSizeKb: 2048,
    ),
    StudyMaterialModel(
      id: 'mat_002',
      ...
      targetCourses: [AppConstants.courseTypes[2]],
      fileSizeKb: 1024,
    ),
    StudyMaterialModel(
      id: 'mat_003',
    ...
    StudyMaterialModel(
      ...
      targetCourses: [AppConstants.courseTypes[1], AppConstants.courseTypes[2]],
      companyTarget: 'Synergy',
      fileSizeKb: 512,
    ),
    StudyMaterialModel(
  ...
  static final List<AnnouncementModel> announcements = [
    AnnouncementModel(
      ...
      targetBranches: [AppConstants.branches[1]],
      targetCourses: [AppConstants.courseTypes[2]],
      isPinned: true,
    ),
    AnnouncementModel(
      ...
      targetBranches: AppConstants.branches,
      targetCourses: [AppConstants.courseTypes[1], AppConstants.courseTypes[2]],
    ),
    AnnouncementModel(
      id: 'ann_003',
      ...
      targetBranches: AppConstants.branches,
      targetCourses: AppConstants.courseTypes,
    ),
    AnnouncementModel(
      id: 'ann_004',
